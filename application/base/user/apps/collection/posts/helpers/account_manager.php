    ...
    public function load_networks() {
        ...
        foreach ( glob(MIDRUB_BASE_USER . 'networks/*.php') as $filename ) {
            ...
            if ( $get->check_availability() ) {
                ...
                //echo "Con<pre>"; print_r($con); echo "<br>"; die;
                // Get network info
                $info = $get->get_info();

                //echo "<pre>"; print_r($info); echo "<br>";
                ...
                //echo "Default number of accounts"; print_r($num_accounts); echo "<br>";
                ...
                //echo "Verify if network has accounts"; print_r($num_accounts); echo "<br>";

                // Get the network's name
                $netw = ucwords(str_replace('_', ' ', $className));

                //echo "Get the network's name"; print_r($netw); echo "<br>";

                $network_selected = '';

                //echo "network_selected"; print_r($network_selected); echo "<br>";
                ...
                //echo "network_selected"; print_r($netw); echo "<br>";
                ...
                //echo "Classes"; print_r($social_networks); echo "<br>";
                //die;
        ...
        if ( $social_networks ) {
            ...
            $social_data = '<div class="row">'
                                ...
                                . '</div>'
                                . '<div class="col-xl-5">'
                                    . '<div class="row manage-accounts-search-form testaccount">'
                                        ...
                                        . '<div class="col-xl-5 col-sm-5 col-5">'
                                            . '<button type="button" class="newaccount manage-accounts-new-account' . $display_hidden_content . '">'
